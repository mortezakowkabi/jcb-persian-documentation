...
The [list of videos](https://www.youtube.com/playlist?list=PLQRGFI8XZ_wtGvPQZWBfDzzlERLQgpMRE) that are already available are listed below. Each is followed by a transcription, edited to be as close to the original video as possible with any corrections to the translation where needed. Screen shots from the video are added if they are deemed necessary to illustrate the text by example, and include the YouTube timeline location where it can be located in the video to quickly locate where that frame begins. Links will be inserted where they occur in the video text to quickly bring up the site for further exploration of the topic. This allows you to follow along and pause the video while exploring that various resources. If the video could not be completed in one sitting, a suggestion is to use the timeline location in YouTube and place it in a copy of the transcript in your editor, using it to mark any locations you may wish to revisit later. Many other uses are possible to enhance your learning experience. The transcripts also facilitates requests for a written manual. To achieve this, a Word document containing the transcripts are made available in developer's manual accompanying this wiki.
